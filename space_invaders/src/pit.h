/*****************************************************************************
* Filename:          C:\Users\superman\Desktop\Team_PT\Lab6/drivers/pit_v1_00_a/src/pit.h
* Version:           1.00.a
* Description:       pit Driver Header File
* Date:              Tue Nov 04 13:29:50 2014 (by Create and Import Peripheral Wizard)
*****************************************************************************/
 ...
 */
#define PIT_SOFT_RST_SPACE_OFFSET (0x00000100)
#define PIT_RST_REG_OFFSET (PIT_SOFT_RST_SPACE_OFFSET + 0x00000000)
 ...
 * @note
 * C-style signature:
 * 	void PIT_mReset(Xuint32 BaseAddress)
 *
 */
#define PIT_mReset(BaseAddress) \
 	Xil_Out32((BaseAddress)+(PIT_RST_REG_OFFSET), SOFT_RESET)
