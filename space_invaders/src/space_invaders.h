...
#define SPACE_BETWEEN_LIVES 4
#define LIVES_END_X SCREEN_X_PIXELS - SCORETEXT_START_X
#define LIVES_START_Y SCORETEXT_START_Y
#define TANKLIVES_PER_ROW 3
#define TANKLIVES_START_X LIVES_END_X - (TANK_WIDTH * TANKLIVES_PER_ROW) - (SPACE_BETWEEN_LIVES * TANKLIVES_PER_ROW)
#define LIVESTEXT_START_X TANKLIVES_START_X - (TEXT_WIDTH * 5  + SPACE_BETWEEN_CHARACTERS * 5)
